#!/usr/bin/env node
/* Removes Lakeside, Riverside and Canalside from the setting choice lists,
 * now that batch 2 has merged every row carrying them into `Waterfront` (§42B).
 *
 * Run AFTER apply-freshwater-batch2-2026-09-11.mjs, and it REFUSES if any row
 ...
 *
 *   node retire-freshwater-choices-2026-09-11.mjs              # dry run
 *   node retire-freshwater-choices-2026-09-11.mjs --confirm    # writes
 */
...
const SNAPSHOT = path.join(HERE, "retire-freshwater-choices-2026-09-11-snapshot.json");
const CONFIRM = process.argv.includes("--confirm");

const RETIRE = ["Lakeside", "Riverside", "Canalside"];
