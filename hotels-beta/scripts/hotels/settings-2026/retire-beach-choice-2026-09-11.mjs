#!/usr/bin/env node
/* Removes Beach from the setting choice lists — the last retirement of §42B,
 * now that batch 2 has merged every row carrying them into `Waterfront` (§42B).
 *
 * Run AFTER apply-beach-merge-batch5-2026-09-11.mjs, and it REFUSES if any row
 ...
 *
 *   node retire-beach-choice-2026-09-11.mjs              # dry run
 *   node retire-beach-choice-2026-09-11.mjs --confirm    # writes
 */
...
const SNAPSHOT = path.join(HERE, "retire-beach-choice-2026-09-11-snapshot.json");
