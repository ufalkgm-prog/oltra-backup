#!/usr/bin/env node
/**
 * Recompute ext_points for the hotels touched by the 2026-07-15 AAA/CAA Five Diamond audit
 * (see apply-award-review-2026-07-15-aaa5d.mjs) — award flags changed on 11 hotels, so
 * ext_points is stale for any of them until this runs (CLAUDE.md §24).
 *
 * Usage (from hotels-beta/):
 *   DIRECTUS_URL=... DIRECTUS_TOKEN=... node scripts/hotels/new-hotels-2026/recalc-ext-points-2026-07-15-aaa5d.mjs
...
const TOUCHED_IDS = ["1649","1749","1246","1653","1673","1719","1720","1756","1758","1766","2046"];
