...
// re-run — an existing field is reported as "already exists" and skipped
// (same pattern as add-ratehawk-image-fields.mjs, §28).
//
...
// only for 409 made a perfectly clean re-run print FAILED on every field.
