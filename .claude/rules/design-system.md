...
| AI | `--ai` | `#A8C4A2` | = rim, bold italic | the concierge entry point only: "Ask AI" first in the site header on every page, plus the same "Ask AI" inside the landing destination field (2026-09-15; it left the Hotels, Flights, Restaurants and Inspire frames) |
